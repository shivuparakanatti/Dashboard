...
const Addnewtask = ()=>{
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 text-xl h-[95vh] text-[#161A30]">
            <form className="bg-[#C7C8CC] px-10 py-20 flex flex-col items-center justify-center gap-4 rounded-md">
            ...
            <input type="submit" className="bg-[#1D2B53]  py-1 w-full text-white" onSubmit={handleCreate} value='Create Task'/>
            </form>
        </div>
